...
namespace BriefFiniteElementNet
{
    ...
    public class MatrixOld : ISerializable, IEnumerable<double>
    {
        ...
        public void MultiplyRowByConstant(int row,double coef)
        {

        }

        public static MatrixOld Repeat(MatrixOld mtx, int ni, int nj)
        {
            var r = mtx.rowCount;
            var c = mtx.columnCount;

            var buf = new MatrixOld(r * ni, c * nj);
        ...
        public static MatrixOld DiagonallyRepeat(MatrixOld mtx, int n)
        {
            var r = mtx.rowCount;
            var c = mtx.columnCount;

            var buf = new MatrixOld(r * n, c * n);
        ...
        /// MatrixOld 1 left,  2 right side of it
        /// </summary>
        /// <param name="m1">The m1.</param>
        /// <param name="m2">The m2.</param>
        /// <returns></returns>
        /// <exception cref="System.NotImplementedException"></exception>
        public static MatrixOld HorizontalConcat(MatrixOld m1, MatrixOld m2)
        {
            if (m1.RowCount != m2.RowCount)
                throw new Exception();

            var buf = new MatrixOld(m1.RowCount, m1.columnCount + m2.columnCount);
        ...
        public static MatrixOld HorizontalConcat(params MatrixOld[] mtx)
        {
            ...
            var buf = new MatrixOld(rwCnt, mtx.Sum(i => i.columnCount));
        ...
        /// MatrixOld 1 on top, 2 below it
        /// </summary>
        /// <param name="m1">The m1.</param>
        /// <param name="m2">The m2.</param>
        /// <returns></returns>
        /// <exception cref="System.NotImplementedException"></exception>
        public static MatrixOld VerticalConcat(MatrixOld m1, MatrixOld m2)
        {
            if (m1.columnCount != m2.columnCount)
                throw new Exception();

            var buf = new MatrixOld(m1.RowCount + m2.RowCount, m1.columnCount);
        ...
        /// <summary>
        /// Creates a MatrixOld from rowcount, colcount and core array
        /// </summary>
        ...
        /// <returns></returns>
        public static MatrixOld FromRowColCoreArray(int rows, int cols, double[] coreArr)
        {
            return new MatrixOld() { columnCount = cols, rowCount = rows, coreArray = coreArr };
        }

        public static MatrixOld RandomMatrixOld(int m, int n)
        {
            var buf = new MatrixOld(m, n);
        ...
        public static MatrixOld CholeskyDecomposeSymmetric(MatrixOld a)
        {
        ...
        /// <summary>
        /// Number of rows of the MatrixOld.
        /// </summary>
        public int RowCount
        {
            get { return rowCount; }
        ...
        /// <summary>
        /// Number of columns of the MatrixOld.
        /// </summary>
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="MatrixOld"/> class from being created.
        /// </summary>
        private MatrixOld()
        {
            CreateCount++;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MatrixOld"/> class.
        /// </summary>
        ...
        /// n
        /// </exception>
        public MatrixOld(int m, int n) : this()
        {
            rowCount = m;
            columnCount = n;
        ...
        /// <summary>
        /// Initializes a new square MatrixOld
        /// </summary>
        /// <param name="n">The MatrixOld dimension.</param>
        public MatrixOld(int n) : this()
        {
            rowCount = n;
            columnCount = n;
        ...
        public static MatrixOld From2DArray(double[,] vals)
        {

            var rows = vals.GetLength(0);
            var cols = vals.GetLength(1);

            var buf = new MatrixOld(rows, cols);
            buf.rowCount = rows;
        ...
        public static MatrixOld FromJaggedArray(double[][] vals)
        {
        ...
        /*
        /// <summary>
        /// Initializes a new instance of the <see cref="MatrixOld"/> class with a 2-d double array.
        /// </summary>
        /// <param name="vals">The values.</param>
        [Obsolete("use static MatrixOld.FromJaggedArray instead")]
        public MatrixOld(double[][] vals) : this()
        {
            var rows = vals.Length;
            var cols = vals.Select(i => i.Length).Max();
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MatrixOld"/> class as a column vector.
        /// </summary>
        ...
        public MatrixOld(int rows, int cols, ref double[] coreArray) : this()
        {
            rowCount = rows;
            columnCount = cols;
        ...
        public static MatrixOld Multiply(MatrixOld m1, MatrixOld m2)
        {
            if (m1.ColumnCount != m2.RowCount)
                throw new InvalidOperationException("No consistent dimensions");

            var res = new MatrixOld(m1.RowCount, m2.ColumnCount);
        ...
        public static void Multiply(MatrixOld m1, MatrixOld m2, MatrixOld result)
        {
            if (m1.ColumnCount != m2.RowCount)
                throw new InvalidOperationException("No consistent dimensions");
        ...
        /// <returns></returns>
        public static void TransposeMultiply(MatrixOld m1, MatrixOld m2, MatrixOld result)
        {
            if (m1.rowCount != m2.RowCount)
                throw new InvalidOperationException("No consistent dimensions");
        ...
        /// <param name="result">The result.</param>
        /// <returns></returns>
        public static void TransposeMultiply(MatrixOld m1, double[] v, double[] result)
        {
        ...
        /// <summary>
        /// Multiplies the specified <see cref="MatrixOld"/> with specified Vector <see cref="vec"/>.
        /// </summary>
        /// <param name="m">The m.</param>
        /// <param name="vec">The vec.</param>
        /// <returns></returns>
        /// <exception cref="BriefFiniteElementNet.MatrixException"></exception>
        public static double[] Multiply(MatrixOld m, double[] vec)
        {
        ...
        /// <summary>
        /// Returns the MatrixOld into pool and invalidates the MatrixOld
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Provides a shallow copy of this MatrixOld in O(row).
        /// </summary>
        /// <returns></returns>
        public MatrixOld Clone()
        {
            var buf = new MatrixOld(this.RowCount, this.ColumnCount);
        ...
        /// <summary>
        /// Swaps each MatrixOld entry A[i, j] with A[j, i].
        /// </summary>
        /// <returns>A transposed MatrixOld.</returns>
        public MatrixOld Transpose()
        {
            var buf = new MatrixOld(this.ColumnCount, this.RowCount);

            var newMatrixOld = buf.CoreArray;

            for (int row = 0; row < this.RowCount; row++)
                for (int column = 0; column < this.ColumnCount; column++)
                    //newMatrixOld[column*this.RowCount + row] = this.CoreArray[row*this.RowCount + column];
                    buf[column, row] = this[row, column];

            buf.CoreArray = newMatrixOld;
            return buf;
        }
        ...
        public static void CopyTo(MatrixOld source, MatrixOld destination)
        {
        ...
        public static void TransposeCopyTo(MatrixOld source, MatrixOld destination)
        {
        ...
        protected bool Equals(MatrixOld other)
        {
        ...
        /// </summary>
        /// <returns>True iff MatrixOld is n by n.</returns>
        ...
        /// </summary>
        /// <returns>True iff MatrixOld is upper trapeze.</returns>
        ...
        /// Checks if A[i, j] == 0 for i > j.
        /// </summary>
        /// <returns>True iff MatrixOld is lower trapeze.</returns>
        ...
        /// <summary>
        /// Checks if MatrixOld is lower or upper trapeze.
        /// </summary>
        /// <returns>True iff MatrixOld is trapeze.</returns>
        ...
        /// <summary>
        /// Checks if MatrixOld is trapeze and square.
        /// </summary>
        /// <returns>True iff MatrixOld is triangular.</returns>
        ...
        /// <summary>
        /// Checks if MatrixOld is square and upper trapeze.
        /// </summary>
        /// <returns>True iff MatrixOld is upper triangular.</returns>
        ...
        /// <summary>
        /// Checks if MatrixOld is square and lower trapeze.
        /// </summary>
        /// <returns>True iff MatrixOld is lower triangular.</returns>
        ...
        public MatrixOld ExtractRow(int i)
        {
            if (i >= this.RowCount || i < 0)
                throw new ArgumentOutOfRangeException("i");

            var mtx = new MatrixOld(1, this.ColumnCount);
        ...
        /// <returns>Row vector.</returns>
        public MatrixOld ExtractColumn(int j)
        {
            if (j >= this.ColumnCount || j < 0)
                throw new ArgumentOutOfRangeException("j");

            var mtx = new MatrixOld(this.RowCount, 1);
        ...
        /// <summary>
        /// Gets the determinant of MatrixOld
        /// </summary>
        /// <returns></returns>
        ...
        {
            if (!IsSquare())
                throw new Exception("MatrixOld must be square");

            var buf = (double[])rightSide.Clone();

            var n = this.rowCount;

            var clone = //Pool != null ? Pool.Allocate(n, n) : 
                new MatrixOld(n, n);
            ...
            {//find next pivot
                ...
                for (var j = 0; j < n; j++) // do for each column
                {
                    ...
                    if (pivot == -1)
                        throw new Exception("singular MatrixOld");
            ...
            var buf2 = new double[n];// MatrixOld.Multiply(clone.Transpose(), buf);
        ...
        public static double[,] To2DDoubleArray(MatrixOld mtx)
        {
        ...
        public static double[][] ToJaggedArray(MatrixOld mtx)
        {
        ...
        /// <summary>
        /// Creates a new Identity MatrixOld.
        /// </summary>
        /// <param name="n">The n.</param>
        /// <returns></returns>
        public static MatrixOld Eye(int n)
        {
            var buf = new MatrixOld(n, n);
        ...
        /// <summary>
        /// Creates row by n MatrixOld filled with zeros.
        /// </summary>
        /// <param name="m">Number of rows.</param>
        /// <param name="n">Number of columns.</param>
        /// <returns>row by n MatrixOld filled with zeros.</returns>
        public static MatrixOld Zeros(int m, int n)
        {
            return new MatrixOld(m, n);
        }

        /// <summary>
        /// Creates n by n MatrixOld filled with zeros.
        /// </summary>       
        /// <param name="n">Number of rows and columns, resp.</param>
        /// <returns>n by n MatrixOld filled with zeros.</returns>
        public static MatrixOld Zeros(int n)
        {
            return new MatrixOld(n);
        }

        /// <summary>
        /// Creates row by n MatrixOld filled with ones.
        /// </summary>
        /// <param name="m">Number of rows.</param>
        /// <param name="n">Number of columns.</param>
        /// <returns>row by n MatrixOld filled with zeros.</returns>
        public static MatrixOld Ones(int m, int n)
        {
            var buf = new MatrixOld(m, n);
        ...
        /// <summary>
        /// Creates n by n MatrixOld filled with ones.
        /// </summary>        
        /// <param name="n">Number of columns.</param>
        /// <returns>n by n MatrixOld filled with ones.</returns>        
        public static MatrixOld Ones(int n)
        {
            var buf = new MatrixOld(n);
        ...
        /// <summary>
        /// Checks if MatrixOld is n by one or one by n.
        /// </summary>
        ...
        /// <summary>
        /// Generates diagonal MatrixOld
        /// </summary>
        /// <param name="diag_vector">column vector containing the diag elements</param>
        /// <returns></returns>
        public static MatrixOld Diag(MatrixOld diag_vector)
        {
        ...
        /// <summary>
        /// Creates n by n identity MatrixOld.
        /// </summary>
        /// <param name="n">Number of rows and columns respectively.</param>
        /// <returns>n by n identity MatrixOld.</returns>
        public static MatrixOld Identity(int n)
        {
            return Eye(n);
        }
        ...
        public static MatrixOld operator *(
            MatrixOld m1, MatrixOld m2)
        {
            return MatrixOld.Multiply(m1, m2);
        }

        public static double[] operator *(
            MatrixOld m1, double[] vec)
        {
            var m2 = new MatrixOld(vec);

            var res = MatrixOld.Multiply(m1, m2);

            return res.coreArray;
        }

        public static MatrixOld operator *(
            double coeff, MatrixOld mat)
        {
            ...
            var buf = new MatrixOld(mat.RowCount, mat.ColumnCount);
        ...
        public static MatrixOld operator +(
            MatrixOld mat1, MatrixOld mat2)
        {
            MatrixException.ThrowIf(mat1.RowCount != mat2.RowCount || mat1.ColumnCount != mat2.ColumnCount,
                "Inconsistent MatrixOld sizes");

            var buf = new MatrixOld(mat1.RowCount, mat1.ColumnCount);
        ...
        public static void Plus(MatrixOld mat1, MatrixOld mat2, MatrixOld result)
        {
        ...
        public static void InplacePlus(MatrixOld mat1, MatrixOld mat2)
        {
            MatrixException.ThrowIf(
        ...
        public static void InplacePlus(MatrixOld mat1, MatrixOld mat2, double coefficient)
        {
            MatrixException.ThrowIf(
                mat1.RowCount != mat2.RowCount || mat1.ColumnCount != mat2.ColumnCount
                , "Inconsistent MatrixOld sizes");
        ...
        public static bool operator ==(MatrixOld left, MatrixOld right)
        {
        ...
        /// <summary>
        /// Fills the MatrixOld in more straight way!
        /// it is assumed that vals are columns and mappind 2d array to 1d is by placing MatrixOld columns under each other
        /// </summary>
        ...
        public static MatrixOld DotDivide(MatrixOld a1, MatrixOld a2)
        {
            if (a1.rowCount != a2.rowCount || a1.columnCount != a2.columnCount)
                throw new Exception();

            var buf = new MatrixOld(a1.rowCount, a1.columnCount);
        ...
        public static MatrixOld DotMultiply(MatrixOld a1, MatrixOld a2)
        {
            if (a1.rowCount != a2.rowCount || a1.columnCount != a2.columnCount)
                throw new Exception();
        ...
        public static double DotProduct(MatrixOld a1, MatrixOld a2)
        {
            if (a1.rowCount != a2.rowCount || a1.columnCount != a2.columnCount)
                throw new Exception();
        ...
        /// <summary>
        /// Fills the MatrixOld rowise (all rows of new MatrixOld are beside each other).
        /// </summary>
        /// <param name="members">The members.</param>
        /// <exception cref="System.Exception"></exception>
        public void FillMatrixOldRowise(params double[] members)
        {
        ...
        /// <summary>
        /// Fills the MatrixOld col wise.
        /// </summary>
        /// <param name="members">The members.</param>
        /// <exception cref="System.Exception"></exception>
        public void FillMatrixOldColWise(params double[] members)
        {
            if (members.Length != this.coreArray.Length)
                throw new Exception();
