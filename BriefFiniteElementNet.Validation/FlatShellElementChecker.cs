    ...
    public static class FlatShellElementChecker
    {
        ...
        public static void Test3()
        {
            ...
            foreach (var elm in model.Elements)
            {
                ...
                triElm.Material = new UniformIsotropicMaterial(e, no);
                triElm.Section = new UniformParametric2DSection(t);
                triElm.Behavior = PlateElementBehaviour.Membrane;
            ...
            {//write internal forces
                ...
                var localS = (targetElement as TriangleElement).GetInternalStress(new double [] { 0.166666666, 0.6666666, 1.0 },
                    LoadCombination.DefaultLoadCombination, SectionPoints.Envelope);//tensor in local coordinate system

              //  var globalS = (targetElement as TriangleElement).RotateTensor(localS.MembraneTensor, Plane.XZPlane);//tensor in global coordinate system
        ...
        public static void Test1()
        {
            ...
            foreach (var elm in model.Elements)
            {
                ...
                triElm.Material = new UniformIsotropicMaterial(e, no);
                triElm.Section = new UniformParametric2DSection(t);
                triElm.Behavior = PlateElementBehaviours.PlateBending;
            }
        ...
        public static void Test6()
        {
            ...
            //{
            //    //stresses
            //    var cElms = model.Elements.Cast<TriangleElement>().Where(i => i.Nodes.Contains(C)).ToArray();
            //    var DElms = model.Elements.Cast<TriangleElement>().Where(i => i.Nodes.Contains(D)).ToArray();
            //    var EElms = model.Elements.Cast<TriangleElement>().Where(i => i.Nodes.Contains(E)).ToArray();

            //    var globTensor = new Func<TriangleElement, MembraneStressTensor>(elm =>
            //    {
        ...
        public static void Test6_2()
        {
            ...
            //    var bfeElms = new[] {0, 37, 40, 42}.Select(i => model.Elements[i]).Cast<TriangleElement>().ToArray();
