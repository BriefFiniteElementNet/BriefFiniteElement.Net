    ...
    internal static class GraphHelper
    {
        ...
        public static int[] EliminationTree(int m, int n, int[] colptr, int[] rowind, bool ata)
        {
            ...
            for (k = 0; k < n; k++)
            {
                ...
                {
                    i = ata ? (prev[prev_offset + rowind[p]]) : (rowind[p]);
                    ...
                    if (ata) prev[prev_offset + rowind[p]] = k;
                }
            }
            return parent;
        }
        ...
        public static int Reach(int[] Gp, int[] Gi, int[] Bp, int[] Bi, int n, int k, int[] xi, int[] pinv)
        {
            ...
            for (p = Bp[k]; p < Bp[k + 1]; p++)
            {
                ...
                {
                    top = GraphHelper.DepthFirstSearch(Bi[p], Gp, Gi, top, xi, xi, n, pinv);
                }
            }
